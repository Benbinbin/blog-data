...
:gear: 代码具体演示效果可以查看这个 [Codepen](https://codepen.io/benbinbin/pen/LYeZaWL)
...
* [Brushable Scatterplot](https://observablehq.com/@d3/brushable-scatterplot)

* [Brushable Scatterplot Matrix](https://observablehq.com/@d3/brushable-scatterplot-matrix)

:mag: 所参考的 Observable Notebook：[Brushable Scatterplot](https://observablehq.com/@d3/brushable-scatterplot) 和 [Brushable Scatterplot Matrix](https://observablehq.com/@d3/brushable-scatterplot-matrix)

:gear: 可以在 Observable 的这个 [notebook](https://observablehq.com/@benbinbin/brushable-scatterplot) 里查看我为代码添加的更详细的注释

:gear: 这是在 [Codepen](https://codepen.io/benbinbin/pen/QWQyKBL) 平台中对该官方样例的复现。:bulb: 该复现示例中没有设置响应性及之前说到的一些交互，后续可以考虑将它们与刷选操作相结合
